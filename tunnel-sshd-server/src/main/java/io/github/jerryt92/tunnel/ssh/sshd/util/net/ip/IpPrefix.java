...
public class IpPrefix {
    ...
    public boolean isMulticast() {
        if(isIp4()) {
            Ip4Prefix ip4 = this.getIp4Prefix();
            return null != ip4 && IPV4_MULTICAST_PREFIX.contains(ip4);
        } else {
            Ip6Prefix ip6 = this.getIp6Prefix();
            return null != ip6 && IPV6_MULTICAST_PREFIX.contains(ip6);
        }
    }
